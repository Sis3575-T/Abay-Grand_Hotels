...
import fallbackHero from '../assets/Presidential.jpg'
...
const Hero = () => {
  ...
  const settingsImage = settings?.heroImage
  const heroBg = settingsImage && settingsImage.trim() ? settingsImage : fallbackHero
