...
const HotelList = () => {
  ...
  return (
    <div id="rooms-section" ref={sectionRef} className='bg-[#f7f0eb] py-16 px-4'>
            ...
            visibleRooms.map((room) => {
              ...
              return (
                <div key={_id} className='bg-white rounded-lg shadow overflow-hidden'>
                  ...
                  <div className='grid grid-cols-2 gap-4 text-base text-gray-700 px-5 pb-4'>
                  ...
                  <div className='px-5 pb-4 text-center'>
                    <Link
                      to={`/room/${_id}`}
                      className='inline-block w-1/2 bg-lime-600 text-white text-center font-semibold py-2.5 px-4 rounded hover:bg-lime-700 transition-colors duration-200'
                    >
                      Book Now
                    </Link>
                  </div>
        ...
        {!loading && hasRooms && rooms.length > 4 && (
          <div className='flex justify-center mt-10'>
            <button
              ...
              className='bg-lime-600 text-white font-semibold py-3 px-10 rounded transition-all duration-200 hover:bg-lime-700'
            >
